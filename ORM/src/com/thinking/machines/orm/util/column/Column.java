...
public static Map<String,Set<String>> getMapOfTablesWithColumns(DatabaseMetaData databaseMetaData,Set<String> setOfTables) throws DataException
{
ResultSet columns=null;
...
Map<String,Set<String>> mapOfTablesWithColumns=new HashMap<>();

try
{


for(String tableNameInDB: setOfTables)
{

columns=databaseMetaData.getColumns(null,null,tableNameInDB,"%");

setOfColumns=new LinkedHashSet<>();
...
mapOfTablesWithColumns.put(tableNameInDB,setOfColumns);
